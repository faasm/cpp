...
HOST_IFACE_FUNC
void __faasm_write_state(const char *key, const unsigned char *data,
                         long dataLen);

HOST_IFACE_FUNC
void __faasm_append_state(const char *key, const unsigned char *data,
                          long dataLen);

HOST_IFACE_FUNC
void __faasm_read_appended_state(const char *key, unsigned char *data,
                                 long dataLen, long nElems);
...
HOST_IFACE_FUNC
unsigned int __faasm_chain_ptr(int (*funcPtr)(), const unsigned char *inputData,
                               long inputDataSize);
...
HOST_IFACE_FUNC
unsigned int __faasm_chain_py(const char *name, const unsigned char *inputData,
                              long inputDataSize);
